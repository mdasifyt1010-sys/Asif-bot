...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "আমার এ এত ডাকিস না আমি আসিফ বস এর সাথে ব্যাস্ত আছি 😌🙂‍↔️",
          "চুপ থাক তুই বিছানায় মুতোছ 🤒🤣😹 ",
          "—হাজারো লুচ্চা লুচ্চির ভিরে-🙊🥵আমার বস আসিফ এক নিস্পাপ ভালো মানুষ-🥱🤗🙆‍♂️",
          "bot না বলে janu বল janu😾😼",
          "যাও-🙂-আমার বস আসিফ এর সাথে  প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗",
          "প্রেম করতে চাইলে বস আসিফ ইনবক্সে চলে যা 😏🐸 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/share/1Aweww5ugb/",
          "আমাকে এতো না ডেকে বস আসিফ কে একটা gf দে 🙄",
          "বেশি bot bot করলে left নিবো কিন্তু 😡😡",
          "কিরে বোকাচোদা এত ডাকিস কেন কি বলবি তাড়াতাড়ি বল তোর কথা শুনার টাইম নাই 😾😾😼"
        ];
